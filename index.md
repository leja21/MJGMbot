...
### 😊 **갓마더와의 대화법**
  ...
  5. **현재 이용하는 정보로 다시 돌아가고 싶으면 '이전' 또는 '뒤로'를 입력**해 주세요.
  6. **대화를 끝내고 싶으시면 '종료' 버튼을 누르거나 입력해 주세요.**
  7. **사용 후기를 남겨 주시면 좀 더 친절하고 전문적인 갓마더가 되는데 도움**이 될 것입니다.


### 🏤**서울마장초등학교** [학교홈페이지](https://majang.sen.es.kr) 
